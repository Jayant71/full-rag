...
from app.utils.embeddings.hg_embeddings import HuggingFaceEmbedding
from app.utils.logger import vector_store_logger as VL


class ChromadbVectorStore:
    def __init__(self, persist_directory: str, collection_name: str, embedding_function=HuggingFaceEmbedding(), embedding_model: str = "sentence-transformers/all-mpnet-base-v2"):
